...
#' Also produces the F value for the overall analysis and for the first contrast
#' versus the group means model. Assumes sphericity.
#'
#'
#' @usage L_1way_RM_ANOVA(dat, group, ID, contrast1=NULL, contrast2=NULL)
#'
...
L_1way_RM_ANOVA <- function(dat, group, ID, contrast1=NULL, contrast2=NULL) {
...
# conventional frequentist statistics
  ...
  "\n\nOverall analysis F(",dfv[2],",",dfv[3],") = ", round(Fval,3), ", p = ", round(Pval,5),
  ...
  invisible(list(S.12 = S_12, S.1m = S_cont1_means, S.cont.12 = S_cont_12,
                 ...
                 Fval.c1 = Fval_c1, df.1 = df1, P.val1 = Pval_c1))
}
