...
L_efficacy <- function(a, n, null=0, exp.eff=NULL, L.int=2, alpha=0.05, toler=0.0001){
  ...
  cat("\nSupport for observed efficacy =  ", eff, " (dashed line)",
      "\n versus null of ", null, " (green line) = ", round(S.eff,3),
      "\n Support for expected efficacy (blue line) of ", exp.eff,
      " versus null value = ", S.exp_null, sep= "", "\n   S-", L.int,
  ...
  invisible(list(S.val = S.eff,  obs.eff = eff, null = null, exp.eff = exp.eff,
