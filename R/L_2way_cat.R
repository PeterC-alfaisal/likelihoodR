...
# evidence for trend
  ...
  cat("\nSupport for interaction = ", round(S2wayc,3), sep= "",
    ", corrected for ", df, " df", "\n Support for rows main effect = ",
    round(RowMain_c,3), "\n Support for columns main effect = ",
    round(ColMain_c,3), ", corrected for ", length(row_sum)-1,
    " and ", length(col_sum)-1, " df.",
